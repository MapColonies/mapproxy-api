...
*/}}
{{- define "mapproxy-api.environment" -}}
...
*/}}
{{- define "mapproxy-api.cloudProviderFlavor" -}}
...
*/}}
{{- define "mapproxy-api.cloudProviderDockerRegistryUrl" -}}
...
*/}}
{{- define "mapproxy-api.cloudProviderImagePullSecretName" -}}
