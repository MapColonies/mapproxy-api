...
import {
  ...
  getFileExtension,
  getRedisCacheName,
  isLayerNameSuffixRedis,
  replaceYamlFileContent,
...
describe('utils', () => {
  ...
  describe('#getFileExtension', () => {
    it('should return the file extension from a path', function () {
      ...
      // action
      const action = () => getFileExtension(path);
  ...
  describe('#getRedisCacheName', () => {
    it('should return redis cache name', function () {
      ...
      // action
      const action = () => getRedisCacheName(layerName);
  ...
  describe('#isLayerNameSuffixRedis', () => {
    it('should return true for redis cache name', function () {
      ...
      // action
      const action = () => isLayerNameSuffixRedis(layerName);
